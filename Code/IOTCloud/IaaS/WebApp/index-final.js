...
app.get('/dashboard', function (req, res) {
  ...
  html += '<link rel="stylesheet" type="text/css" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css">'
  html += '<table cellspacing="0"><thead><tr><th>Time</th><th>Temperature</th><th>Humidity</th></tr></thead><tbody>\n'
  records.slice(-10).reverse().forEach(function (record) {
    html += '<tr><td>' + new Date(record.timestamp) + '</td><td>' + record.temperature + '</td><td>' + record.humidity + '</td><tr>'
  })
  html += '</tbody></table>\n'
  html += '</body></html>\n'
  // Send response
